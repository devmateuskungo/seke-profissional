...
/** GET /api/marketplace/professionals/:id/services — proxy para API externa GET /marketplace/professionals/:id/services */
export async function GET(
  ...
  try {
    ...
    const endpoint = `${getApiBaseUrl()}/marketplace/professionals/${encodeURIComponent(trimmed)}/services`
